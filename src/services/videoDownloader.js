...
//     }
//   }
//   async testTrueHD(url) {
//     const output = path.join(this.tempDir, "test_hd.mp4");
...
// ==========================================
// STEP 2: FIXED videoDownloader.js
// ==========================================
// PREMIUM MODE - No file size limits!
// Auto-deletes files after 10 minutes
// R2 multipart upload for files >2GB
