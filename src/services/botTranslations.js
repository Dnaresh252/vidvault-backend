...
const T = {
  ...
  en: {
    ...
    downloadReady: ({ title, label, size, platform, url, used, limit, isPremium }) =>
      ...
      `${isPremium
        ...
        : `📊 *${used}/${limit}* free downloads used`
      }`,
  ...
  hi: {
    ...
    welcome: ({ name, isReturning, limit }) =>
      ...
      `━━━━━━━━━━━━━━━━━━━━\n` +
      `🆓 *Free* — ${limit} downloads/month\n` +
      `⭐ *Premium ₹79/month* — Unlimited \\+ 4K \\+ MP3\n` +
      `━━━━━━━━━━━━━━━━━━━━\n\n` +
    ...
    lockedQuality: `🔒 Premium quality — ₹79/month में upgrade करो!`,
  },
  ...
  ar: {
    ...
    lockedQuality: `🔒 جودة Premium — قم بالترقية مقابل ₹79/شهر!`,
  },
  ...
  es: {
    ...
    lockedQuality: `🔒 Calidad Premium — mejora por ₹79/mes!`,
  },
  ...
  pt: {
    ...
    lockedQuality: `🔒 Qualidade Premium — faça upgrade por ₹79/mês!`,
  },
  ...
  ru: {
    ...
    lockedQuality: `🔒 Premium качество — апгрейд за ₹79/мес!`,
  },
  ...
  id: {
    ...
    lockedQuality: `🔒 Kualitas Premium — upgrade ₹79/bulan!`,
  },
  ...
  tr: {
    ...
    lockedQuality: `🔒 Premium kalite — ₹79/ay ile yükseltin!`,
  },
  ...
  fr: {
    ...
    upgradeNudge3:
      ...
      `*₹79/mois → Illimité pour toujours*\n` +
    ...
    lockedQuality: `🔒 Qualité Premium — améliorez pour ₹79/mois!`,
  },
  ...
  de: {
    ...
    welcome: ({ name, isReturning, limit }) =>
      ...
      `⭐ *Premium ₹79/Monat:* Unbegrenzt • 4K\n\n` +
      `━━━━━━━━━━━━━━━━━━━━\n` +
    ...
    lockedQuality: `🔒 Premium-Qualität — upgrade für ₹79/Monat!`,
  },
  ...
  bn: {
    ...
    lockedQuality: `🔒 Premium মান — ₹79/মাসে আপগ্রেড করুন!`,
  },
  ...
  ur: {
    ...
    lockedQuality: `🔒 Premium معیار — ₹79/مہینہ میں اپ گریڈ کریں!`,
  },
  ...
  ta: {
    ...
    lockedQuality: `🔒 Premium தரம் — ₹79/மாதம் மேம்படுத்துங்கள்!`,
  },
  ...
  te: {
    ...
    lockedQuality: `🔒 Premium నాణ్యత — ₹79/నెలకు అప్‌గ్రేడ్!`,
  },
  ...
  zh: {
    ...
    lockedQuality: `🔒 Premium 画质 — ₹79/月升级!`,
  },
  ...
  ko: {
    ...
    lockedQuality: `🔒 Premium 품질 — ₹79/월로 업그레이드!`,
  },
  ...
  ja: {
    ...
    lockedQuality: `🔒 Premium品質 — ₹79/月でアップグレード!`,
  },
  ...
  vi: {
    ...
    lockedQuality: `🔒 Chất lượng Premium — nâng cấp ₹79/tháng!`,
  },
  ...
  th: {
    ...
    lockedQuality: `🔒 คุณภาพ Premium — อัปเกรด ₹79/เดือน!`,
  },
  ...
  it: {
    ...
    lockedQuality: `🔒 Qualità Premium — aggiorna per ₹79/mese!`,
  },
};
